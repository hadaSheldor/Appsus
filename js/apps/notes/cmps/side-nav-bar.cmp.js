export default {
    template: `
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                    ...
                    <!-- <img class="menu-icon" src="../../../../img/light-bulb64.png" > -->
                    Notes
                </div>
                <div class="menu-item reminders">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                    ...
                    <!-- <img class="menu-icon" src="../../../../img/reminder50.png"> -->
                    Reminders
                </div>
                <div class="menu-item lable">
                    <!-- <img class="menu-icon" src="../../../../img/label64.png"> -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                ...
                <div class="menu-item edit-lable">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                    ...
                    <!-- <img class="menu-icon" src="../../../../img/edit50.png"> -->
                    Edit labels
                </div>
                <div class="menu-item archive">
                    <!-- <img class="menu-icon" src="../../../../img/archive50.png"> -->
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34">
                    ...
                    <!-- <img class="menu-icon" src="../../../../img/trash-can50.png"> -->
                    Trash
                </div>
                </section>
            `,
